...
DCrawler.prototype.init = function (options) {
    var self = this;
    ...
    var configDefaultOptions = {
        ...
        beforeStart:        function (config) {
            console.log(config.name + " started at " + new Date());
        },
        ...
        onComplete:         function (config) {
            console.log(config.name + " completed at " + new Date());
        }
    };
