 ...
 * @param {object} {logOptions={}} - winston-mongodb log options.
 */
DCrawler.prototype.init = function (options, logOptions) {
    var self = this;
 ...
 * @constructor {object} {logOptions: {dbUri: 'mongodb://0.0.0.0:27017/crawler', storeHost: true}} - winston-mongodb log options.
 */
function DCrawler(options, logOptions) {
    if (!options) options = {};
    var self = this;
    self.init(options, logOptions);
}
